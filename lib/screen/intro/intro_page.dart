...
import 'package:da/screen/register/register_client_screen.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            TextCustom(text: 'Star ', color:  Color(0xff0C6CF2), fontWeight: FontWeight.w500, fontSize: 25),
            ...
            Column(
              children: [
                ...
                _BtnSocial(
                  ...
                  textColor: Colors.white,
                  onPressed: () => Navigator.push(context, routeCustom(page: RegisterClientPage())),
                ),
                ...
                Padding(
                  ...
                  child: BtnCustom(
                    ...
                    height: 50,
                    fontSize: 20,
                    onPressed: () => Navigator.push(context, routeCustom(page: LoginPage())),
                  ),
                ),
                SizedBox(height: 20.0)
              ],
