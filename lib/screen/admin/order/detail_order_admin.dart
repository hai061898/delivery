    ...
    return BlocListener<OrdersBloc, OrdersState>(
      listener: (context, state) {
        ...
        if( state is LoadingOrderState ){
          ...
          modalSuccess(context, 'DISPATCHED', () => Navigator.pushReplacement(context, routeCustom(page: OrdersAdminPage())));
              ...
              child: FutureBuilder<List<DetailsOrder>?>(
                ...
                builder: (context, snapshot) 
                  => ( !snapshot.hasData )
                    ...
                    : ListProductsDetails(listProductDetails: snapshot.data!)
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        TextCustom(text: 'Total', color: ColorsCustom.secundaryColor, fontSize: 22, fontWeight: FontWeight.w500),
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        TextCustom(text: 'Cliente:', color: ColorsCustom.secundaryColor, fontSize: 16),
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        TextCustom(text: 'Date:', color: ColorsCustom.secundaryColor, fontSize: 16),
                        TextCustom(text: DateCustom.getDateOrder(order.currentDate.toString()), fontSize: 16),
                      ],
                    ),
                    SizedBox(height: 10.0),
                    TextCustom(text: 'Address shipping:', color: ColorsCustom.secundaryColor, fontSize: 16),
                    SizedBox(height: 5.0),
                    ...
                    ? Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        TextFrave(text: 'Delivery', fontSize: 17, color: ColorsCustom.secundaryColor),
                        Row(
                          children: [
                            Container(
                              height: 40,
